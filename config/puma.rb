...
# After boot, open Postgres/Redis and refresh homepage + admin backfill stats so
# the first user/admin request after a dyno start is not paying cold aggregates.
on_booted do
